<!--
README / Deploy Instructions (also included inside this file near the bottom)

Quick steps to put this on GitHub and enable Pages:

1. Create a new repository on GitHub (e.g. "ux-portfolio").
2. On your machine, in the folder containing this index.html:

   git init
   git add index.html
   git commit -m "Initial UX portfolio"
   git branch -M main
   git remote add origin https://github.com/<your-username>/ux-portfolio.git
   git push -u origin main

3. Enable GitHub Pages:
   - Go to the repo Settings -> Pages -> Branch: main / root -> Save
   - Or create a branch gh-pages and push; Pages will serve from that branch.

4. Your site will be available at https://<your-username>.github.io/ux-portfolio/ (may take a minute).

Customizing content:
- Replace the placeholder SVGs with your project screenshots (put images into an "assets" folder and change the <img> src accordingly).
- Edit project cards in the HTML (look for <!-- PROJECT CARD TEMPLATE -->)
- Replace contact email and resume link.

Accessibility & SEO tips included in comments inside the file.
